...
- `extension/` — расширение Chrome MV3. Хранит только адрес сервера и пароль доступа.
...
Откройте `chrome://extensions`, включите режим разработчика, «Загрузить распакованное», выберите `extension/dist`. В настройках расширения укажите адрес сервера и тот же `SHARED_TOKEN`.
